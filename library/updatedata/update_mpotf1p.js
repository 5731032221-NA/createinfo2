...
module.exports.insert = (async function (req, res, dtf, MBCODE) {
        ...
        if(typeof req.body.CONTACT_MOBILE != 'undefined'){
                contactmobile = req.body.CONTACT_MOBILE;
        }
        ...
        var update_params = [req.body.DEMO_TH_NAME, req.body.DEMO_TH_SURNAME, 999912, req.body.CUST_ID_OR_PASSPORT, req.body.DEMO_DOB, contacthome, contactmobile, parseInt(date_str), parseInt(date_str), 'A', 0, 'A'];
        /*
